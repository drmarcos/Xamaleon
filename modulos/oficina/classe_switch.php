...
@------------------------------------------------------------------------------------*/
class meuSwitch{
	function mostraOficina($oficinaCadastrado){
		global 	$_ESPORTES,$_ARTES,$_CIENCIAS,$_LITERATURA,$_ESTUDOS_SOCIAIS;
							switch ($oficinaCadastrado){
							case 0:
								print $_ESPORTES;
								break;
							case 1:
...
$_POS_CONCLUIDO,$_MESTRADO_CURSANDO,$_MESTRADO_CONCLUIDO,$_DOUTORADO_CURSANDO,$_DOUTORADO_CONCLUIDO,$_MBA_CURSANDO,$_MBA_CONCLUIDO;		
	...
	function mostraHorario($horarioCadastrado){
		global $_MANHA,$_TARDE,$_NOITE;
							switch ($horarioCadastrado){
							case 0:
								print $_MANHA;
								break;
							case 1:
