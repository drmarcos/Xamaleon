...
/* -- [ MATR̓ULA ] -- */ 
	    ...
	    $pdf->Cell(0,6,"$_MATRICULA : $xml->IDENTIFICACAO",0,1,'L',true);
	    $pdf->Ln(4);
...
/* -- [ BAIRRO ] -- */ 
	    ...
	    $pdf->SetFont('Times','',8);
	    $pdf->SetFillColor($corLinha2);
	    $pdf->Cell(0,5,corrigeleitura($_BAIRRO) ." : ". corrigeleitura($xml->BAIRRO),0,1,'L',true);
	    $pdf->Ln(0);
...
/* -- [ CIDADE ] -- */ 
	    ...
	    $pdf->SetFont('Times','',8);
	    $pdf->SetFillColor($corLinha1);
	    $pdf->Cell(0,5,corrigeleitura($_CIDADE)." : ". corrigeleitura($xml->CIDADE),0,1,'L',true);
	    $pdf->Ln(0);	
	}
	$i++;
	}
